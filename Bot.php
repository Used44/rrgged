...
ob_start();
$API_KEY = '1355680938:AAFWEKoxMpyjh6oIohGbm7lRdbcv5uiOjis'; //add your bot token
$sudo = 1094997299; // add your id
$bot_id = 1355680938; 
$e = "@AMERIIC_BOT";
...
👨🏽‍🔧",
    'reply_markup'=>json_encode([
      'inline_keyboard'=>[
        [['text'=>"آلمـطـور 🌿",'url'=>"https://t.me/used4"]]
    ]
...
bot('sendContact',[
'chat_id'=>$chat_id,
'phone_number'=>"+9647714897390",
'first_name'=>"HUSSEDIN SALAH♥️ ™`☻",
'last_name'=>"💐🌚",
'reply_to_message_id'=>$message->message_id, 
]);
}
...
bot('sendMessage',[
'chat_id'=>$chat_id, 
'text'=>"يَمـه̷̐ إآلُحــ❤ــب يَمـه̷̐ ❤️😍",
'reply_to_message_id'=>$message->message_id, 
]);
}
if($text == "😉"){
